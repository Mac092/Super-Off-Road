========================================================================
    APLICACIÓN DE WIN32: [!output PROJECT_NAME] Información general del proyecto
========================================================================
...
Resource.h
    ...
    Éste es un archivo de icono, que se utiliza como el icono de la aplicación (32x32). Este icono está incluido en el archivo principal de recursos [!output RC_FILE_NAME].

small.ico
    Este es un archivo de icono, que contiene una versión menor (16x16) del icono de la aplicación. Este icono está incluido en el archivo principal de recursos [!output RC_FILE_NAME].
